...
namespace BirthingRooms
{
    ...
    public class BirthingRoom
    {
        ...
        /// <summary>
        /// The queue for the pregnant animals.
        /// </summary>
        private Queue<IReproducer> pregnantAnimals;
        ...
        public BirthingRoom(Employee vet)
        {
            ...
            // Instantiate a new pregnant animals queue.
        ...
        /// </summary>
        public Queue<IReproducer> PregnantAnimals
        {
            get
            {
                return this.pregnantAnimals;
            }

            protected set
            {
                this.pregnantAnimals = value;
            }
        }
        ...
        public IReproducer BirthAnimal(IReproducer reproducer)
        {
            ...
            {
                // Dequeue the first animal from the queue that is pregnant.
